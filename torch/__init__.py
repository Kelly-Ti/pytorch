...
r"""
The torch package contains data structures for multi-dimensional tensors. It also defines mathematical operations that can be performed over these tensors.!!!
